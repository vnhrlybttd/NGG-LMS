...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-edit"></i> Edit Property
        </li>
    </ol>
</nav>
...
@endif
    ...
    {!! Form::model($id, ['method' => 'PATCH','route' => ['PropertyListing.update', $id->id]]) !!}
    @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ld_full_name" required
                                value="{{$id->ld_full_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Address</label>
                            <textarea type="text" class="form-control" name="ld_address"
                                required>{{$id->ld_address}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ld_company_name" required
                                value="{{$id->ld_company_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">TIN Number</label>
                            <input type="text" class="form-control" name="ld_tin_number" required id="tbNum"
                                onkeyup="addHyphen(this)" maxlength="11" value="{{$id->ld_tin_number}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="le_full_name" required
                                value="{{$id->le_full_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Address</label>
                            <textarea type="text" class="form-control" name="le_address"
                                required>{{$id->le_address}}</textarea>
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Email</label>
                            <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text">+63</span>
                                <input type="number" class="form-control" name="le_phone_number" required
                                    pattern="[0-9]*" value="{{$id->le_phone_number}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Website</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="le_company_name" required
                                value="{{$id->le_company_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">TIN Number</label>
                            <input type="text" class="form-control" name="le_tin_number" required id="tbNum2"
                                onkeyup="addHyphen(this)" maxlength="11" value="{{$id->le_tin_number}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ra_full_name" required
                                value="{{$id->ra_full_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Address</label>
                            <textarea type="text" class="form-control" name="ra_address"
                                required>{{$id->ra_address}}</textarea>
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Email</label>
                            <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text">+63</span>
                                <input type="number" class="form-control" name="ra_phone_number" required
                                    pattern="[0-9]*" value="{{$id->ra_phone_number}}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="building_name" required
                                value="{{$id->building_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-dark">Building Address</label>
                            <textarea type="text" class="form-control" name="building_address"
                                required>{{$id->building_address}}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            'Hotel' =>'Hotel',
                            'Housing' => 'Housing'],null, array('class'=>
                'form-control'));
                            !!}
                        </div>
                    </div>
